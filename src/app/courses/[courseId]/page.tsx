            ...
            <div className="mx-auto grid max-w-6xl gap-5 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {course.semesters.map((semester) => (
                <Link key={semester.id} href={`/courses/${course.id}/${semester.id}`}>
                  <div className="group flex h-32 md:h-40 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-border bg-card p-4 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:shadow-lg">
