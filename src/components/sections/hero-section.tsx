...
const HeroSection = () => {
  return (
    <section className="relative flex h-[calc(100vh-70px)] min-h-[500px] md:min-h-[600px] w-full items-center justify-center overflow-hidden bg-transparent text-center text-white">
