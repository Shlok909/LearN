        ...
        subjects: [
          ...
          },
          {
            ...
            resources: { notes: [],
              pyqs: [
                ...
                { id: 2, label: '', url: '#', type: 'pdf' },
                { id: 3, label: '', url: '#', type: 'pdf' },
                { id: 4, label: '', url: '#', type: 'pdf' },
                { id: 5, label: '', url: '#', type: 'pdf' },
                { id: 6, label: '', url: '#', type: 'pdf' },
                { id: 7, label: '', url: '#', type: 'pdf' },
                { id: 8, label: '', url: '#', type: 'pdf' },
                { id: 9, label: '', url: '#', type: 'pdf' },
              ],
              lectures: [
          ...
          { id: '5', 
            ...
            resources: { notes: [],
              ...
              lectures: [
                { id: 1, label: 'Link 1', url: '#', type: 'youtube' },
                { id: 2, label: 'Link 2', url: '#', type: 'youtube' },
                { id: 3, label: 'Link 3', url: '#', type: 'youtube' },
                { id: 4, label: 'Link 4', url: '#', type: 'youtube' },
                { id: 5, label: 'Link 5', url: '#', type: 'youtube' },
                { id: 6, label: 'Link 6', url: '#', type: 'youtube' },
                { id: 7, label: 'Link 7', url: '#', type: 'youtube' },
                { id: 8, label: 'Link 8', url: '#', type: 'youtube' },
                { id: 9, label: 'Link 9', url: '#', type: 'youtube' },
                { id:10, label: 'Link 10',url: '#', type: 'youtube' },
              ],
              practicals: [],
            },
          },
