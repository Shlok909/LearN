...
export const coursesData: CoursesData = {
  bca: {
    ...
    syllabusPdfUrl: "https://drive.google.com/file/d/1Lx4aehsRTuEv1U2dv8Ug6Ef6NxwLMJ7t/view?usp=drive_link",
    semesters: [
      {
        id: 1,
        name: 'Semester 1',
        subjects: [
          {
            ...
            resources: {
              notes: [],
              pyqs: [
                { id: 1, label: 'Programming with C 2024 winter', url: 'https://drive.google.com/file/d/1kDVcc7ICFToPp1812igVbO5wuBAgHirp/view?usp=drive_link', type: 'pdf' },
                { id: 2, label: 'Programing C Winter 2016', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-winter-2016.pdf', type: 'pdf' },
                { id: 3, label: 'Programing C Winter 2015', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-winter-2015.pdf', type: 'pdf' },
                { id: 4, label: 'Programing C Winter 2015_1',url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-winter-2015.pdf', type: 'pdf' },
                { id: 5, label: 'Programing C Summer 2019', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-2207-summer-2019.pdf', type: 'pdf' },
                { id: 6, label: 'Programing C Summer 2018', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-paper-2-summer-2018.pdf', type: 'pdf' },
                { id: 7, label: 'Programing C Winter 2018', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-winter-2018.pdf', type: 'pdf' },
                { id: 8, label: 'Programing C Summer 2017', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-summer-2017.pdf', type: 'pdf' },
                { id: 9, label: 'Programing C Winter 2017', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programming-winter-2017.pdf', type: 'pdf' },
                { id: 9, label: 'Programing C Summer 2016', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-c-programing-summer-2016.pdf', type: 'pdf' },
              ],
              lectures: [
                { id: 1, label: 'Link 1', url: 'https://youtube.com/playlist?list=PLeW6FlBEY6TIYi1cQYV0eZC94IeAC3lFy&si=FB-NOnCO1TxCp4O2', type: 'youtube' },
                { id: 2, label: 'Link 2', url: 'https://youtube.com/playlist?list=PLqleLpAMfxGBn9v-K17ztBfNXHzPnX5sN&si=4ktcDj5oSX6l-Ufw', type: 'youtube' },
                { id: 3, label: 'Link 3', url: 'https://youtube.com/playlist?list=PLXIPR4CD0nopyzv1wp_jkK7pcqvhf6rF3&si=RN5n4So_m8JGm5Ri', type: 'youtube' },
                { id: 4, label: 'Link 4', url: 'https://youtube.com/playlist?list=PL724pdDXl9Q3sf8nEH6z1mfeOPnd-h22L&si=XLcG753_9-A7cPLT', type: 'youtube' },
                { id: 5, label: 'Link 5', url: 'https://youtube.com/playlist?list=PLmRclvVt5DtksgReOH3s7R1_cb1QA8vrb&si=b9z-wc_XmUgKKHRe', type: 'youtube' },
                { id: 6, label: 'Link 6', url: 'https://youtube.com/playlist?list=PLxCzCOWd7aiGmiGl_DOuRMJYG8tOVuapB&si=OuKivd1iMnle_5z9', type: 'youtube' },
                { id: 7, label: 'Link 7', url: 'https://youtube.com/playlist?list=PLxgZQoSe9cg1drBnejUaDD9GEJBGQ5hMt&si=50-yFbF59gd1X2fi', type: 'youtube' },
                { id: 8, label: 'Link 8', url: 'https://youtube.com/playlist?list=PLlg3g5kppv-8b1yZqnc-2yiyhBDHV-4bq&si=7G1nwYR-SvbvjF9K', type: 'youtube' },    
                { id: 9, label: 'Link 9', url: 'https://youtu.be/eWHzz-WHQh4?si=LGAzoWeIY7Mn9UlU', type: 'youtube' },
                { id: 10, label: 'Link 10',url: 'https://youtu.be/qmkCmfLJENU?si=4RQsHeKrd-474mm_', type: 'youtube' },
                { id: 11, label: 'Link 11',url: 'https://youtube.com/playlist?list=PLYwpaL_SFmcBqvw6QTRsA8gvZL3ao2ON-&si=wkAHN0uVN9RQAYPG', type: 'youtube' },  
            ],
              practicals: [{ id: 1, label: 'Programming with C', url: 'https://drive.google.com/file/d/1v8UKajHyX_73dQVeMoOq1gzPAJngigD9/view?usp=drive_link', type: 'pdf' }],
            },
          },
          {
            id: '2',
            ...
            resources: { 
              notes: [],
              pyqs: [
                { id: 1, label: 'Computer Fundamentals 2019', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-2206-summer-2019.pdf', type: 'pdf' },
                { id: 2, label: 'Computer Fundamentals 2018', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-paper-1-summer-2018.pdf', type: 'pdf' },
                { id: 3, label: 'Computer Fundamentals 2018_1',url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-winter-2018.pdf', type: 'pdf' },
                { id: 4, label: 'Computer Fundamentals 2017',url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-summer-2017.pdf', type: 'pdf' },
                { id: 5, label: 'Computer Fundamentals 2017_1',url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-winter-2017.pdf', type: 'pdf' },
                { id: 6, label: 'Computer Fundamentals 2016', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundamentals-winter-2016.pdf', type: 'pdf' },
                { id: 7, label: 'Computer Fundamentals 2016_1', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-computer-fundametal-summer-2016.pdf', type: 'pdf' },
               ],
              lectures: [
                { id: 1, label: 'Link 1', url: 'https://youtube.com/playlist?list=PLGdyq57oHlXDUU6MNVAXqkET-zKWuj5wf&si=vxXwbQCsRgnzz2JF', type: 'youtube' },
                { id: 2, label: 'Link 2', url: 'https://youtube.com/playlist?list=PLOetFSqRMYJ6cup9GQ1hKvr10Wj4xf2_C&si=J8M-SH6WKtXGFEqN', type: 'youtube' },
                { id: 3, label: 'Link 3', url: 'https://youtu.be/1rUevQ3bSEY?si=kq26EAsXeZPDeuFb', type: 'youtube' },
                { id: 4, label: 'Link 4', url: 'https://youtube.com/playlist?list=PLYwpaL_SFmcCaiXeUEjcTzHwIfJqH1qCN&si=cZe5FRw8HXU3XP6p', type: 'youtube' },
                { id: 5, label: 'Link 5', url: 'https://youtube.com/playlist?list=PLeUy5pFI21O_itCISPoYLvwkdIKrcN9it&si=9PwkhDSj6orujSeJ', type: 'youtube' },
                { id: 6, label: 'Link 6', url: 'https://youtube.com/playlist?list=PLxCzCOWd7aiHMonh3G6QNKq53C6oNXGrX&si=KXaXllNVI5Pm8dEr', type: 'youtube' },
                { id: 7, label: 'Link 7', url: 'https://youtu.be/DsK35f8wyUw?si=LCER4-svbVfghSZg', type: 'youtube' },
                { id: 8, label: 'Link 8', url: 'https://youtube.com/playlist?list=PLmXKhU9FNesS4B30OmgxP7nrzq1UhiMiv&si=KyCqoqhwPjQXeEGb', type: 'youtube' },
                { id: 9, label: 'Link 9', url: 'https://youtube.com/playlist?list=PLGdyq57oHlXDkcoU701Y5XLT-t_MW5dYI&si=0ulucRryNxPRfO-g', type: 'youtube' },
                { id:10, label: 'Link 10',url: 'https://youtu.be/DsK35f8wyUw?si=yLTIyRLxXgDWIlgo', type: 'youtube' },
              ],
              practicals: [{ id: 1, label: 'Basics of CAO', url:'https://drive.google.com/file/d/1RxJ__IIB-ST9xKzfHRHNQW17Qp7S8Hyo/view?usp=drive_link', type: 'pdf' }],
            },
          },
          {
            id: '3',
            ...
            resources: { 
              notes: [],
              pyqs: [
                { id: 1, label: 'M.F Summer 2019', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-2209-summer-2019.pdf', type: 'pdf' },
                { id: 2, label: 'M.F Summer 2018', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-paper-4-summer-2018.pdf', type: 'pdf' },
                { id: 3, label: 'M.F Winter 2018', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-winter-2018.pdf', type: 'pdf' },
                { id: 4, label: 'M.F Summer 2017', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-summer-2017.pdf', type: 'pdf' },
                { id: 5, label: 'M.F Winter 2017', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-winter-2017.pdf', type: 'pdf' },
                { id: 5, label: 'M.F Winter 2015', url: 'https://www.rtmnuonline.com/papers/bca-1-sem-discrete-mathematics-1-winter-2015.pdf', type: 'pdf' },
                { id: 6, label: 'M.F Summer 2024', url: 'https://www.rtmnuonline.com/papers/bca-2-sem-discrete-mathematics-2-1303-summer-2024.pdf', type: 'pdf' },
                { id: 7, label: 'M.F Summer 2019_1', url: 'https://www.rtmnuonline.com/papers/bca-2-sem-discrete-mathematics-2-2222-summer-2019.pdf', type: 'pdf' },
                { id: 8, label: 'M.F Summer 2018', url: 'https://www.rtmnuonline.com/papers/bca-2-sem-discrete-mathematics-2-2018.pdf', type: 'pdf' },
                { id: 9, label: 'M.F Winter 2016', url: 'https://www.rtmnuonline.com/papers/bca-2-sem-discrete-mathematics-2-winter-2016.pdf', type: 'pdf' },
              ],
              lectures: [
                { id: 1, label: 'Link 1', url: 'https://youtube.com/playlist?list=PLjmKbIQrlDakoi99SyQPV2rp-huH_-okA&si=AmQMxcrsryWHz3Oc', type: 'youtube' },
                { id: 2, label: 'Link 2', url: 'https://youtube.com/playlist?list=PLxCzCOWd7aiH2wwES9vPWsEL6ipTaUSl3&si=dBQfcvQJ934eRbaj', type: 'youtube' },
                { id: 3, label: 'Link 3', url: 'https://youtu.be/3zOtLEeHygg?si=DzfIR7wryQsPr1IW', type: 'youtube' },
                { id: 4, label: 'Link 4', url: 'https://youtu.be/h4sd7wRcyR0?si=xrtPsb_ZI8oChHb1', type: 'youtube' },
                { id: 5, label: 'Link 5', url: 'https://youtube.com/playlist?list=PLYwpaL_SFmcDKuvj-wIgDnHA5JTfUwrHv&si=jzAHlL25KSoJtG70', type: 'youtube' },
                { id: 6, label: 'Link 6', url: 'https://youtube.com/playlist?list=PLU6SqdYcYsfJ27O0dvuMwafS3X8CecqUg&si=eBaqWjBpPLSbcVsx', type: 'youtube' },
                { id: 7, label: 'Link 7', url: 'https://youtube.com/playlist?list=PLXIPR4CD0nop79j8VPAWd7goPuGRMmaiZ&si=4Iiy1Zm8DsKlCKSA', type: 'youtube' },
                { id: 8, label: 'Link 8', url: 'https://youtu.be/UwYJUKVc-Hs?si=OWGw1tPu8xPzulGB', type: 'youtube' },
                { id: 9, label: 'Link 9', url: 'https://youtu.be/objZSMi4hmo?si=aVngjJCg2c0rSMgX', type: 'youtube' },
                { id:10, label: 'Link 10',url: 'https://youtube.com/playlist?list=PL92RPe36fLKjATSYf6LCoe1sR5GatV6Un&si=VkKaI51HAF1ZtL-k', type: 'youtube' },
                { id:10, label: 'Link 10',url: 'https://youtu.be/3zOtLEeHygg?si=X9O8asgM08nFVDq9', type: 'youtube' },
                { id:11, label: 'Link 11',url: 'https://youtu.be/papVRQqtrgc?si=zQV9DQbNrJXyzj68', type: 'youtube' },
              ],
              practicals: [],
            },
          },
          {
            ...
            resources: { 
              notes: [
                { id: 1, label:'English Whole Book pdf', url: 'https://drive.google.com/file/d/1u7VFb7BWCzb8vfPYwFufK5vUs6VZ9ngB/view?usp=drive_link', type: 'pdf' },
              ],
              pyqs: [
                { id: 1, label:'English pyq 2025', url: 'https://drive.google.com/file/d/1eed82wDLyaZOD0q4Tax5TP6iBW8tbChj/view?usp=drive_link', type: 'pdf' },
              ],
              lectures: [],
              practicals: [],
            },
          ...
          { id: '5', 
            ...
            resources: { 
              notes: [
                { id: 1, label: 'Complete Vedic-Maths Notes (all of course)', url: 'https://drive.google.com/file/d/1LmMIb3PQ-7bRf7JU4okcHHhpIR6eGMJ6/view?usp=drive_link', type: 'pdf' },
              ],
              pyqs: [
                { id: 1, label: 'Vedic Maths 2025', url: 'https://drive.google.com/file/d/1bU8nst08qehEUpemo_6Ye38OTZ6qPOBe/view?usp=drive_link', type: 'pdf' },
                
               ],
              lectures: [
                { id: 1, label: 'Link 1', url: 'https://youtube.com/playlist?list=PL4t_secZTPn6mwWFEdXaIExhGOe88NkNj&si=3WJBFBnZtMOO_NYL', type: 'youtube' },
                { id: 2, label: 'Link 2', url: 'https://youtube.com/playlist?list=PLVLoWQFkZbhUFSIAjbWPVv_mlAAX8BBD1&si=KUfnytQkrz27X9Hg', type: 'youtube' },
                { id: 3, label: 'Link 3', url: 'https://youtube.com/playlist?list=PLCddsmPUA90zbC3awkYSsR8tzpIuFokKu&si=ytuIaqyefhT91GqA', type: 'youtube' },
                { id: 4, label: 'Link 4', url: 'https://youtube.com/playlist?list=PLrpYUF9DFVUNOwBtrT5QfnJKk3pqCL_7i&si=_zApBDtB7fCr2ucD', type: 'youtube' },
                { id: 5, label: 'Link 5', url: 'https://youtube.com/playlist?list=PLjRxXALQprDCg0nr9gzo7hf4VdNLqwASt&si=JT9UmeIl8V33wTI4', type: 'youtube' },
                { id: 6, label: 'Link 6', url: 'https://youtube.com/playlist?list=PLIr32Qn8H7h5kHUG0RGQoGuZJB4fYcWxa&si=r2NJxhUMFFl25dzi', type: 'youtube' },
                { id: 7, label: 'Link 7', url: 'https://youtube.com/playlist?list=PLVacyNOHp_vu6TzYNXErKrbrrke8iosCq&si=dZe36T1C0pp3gn9R', type: 'youtube' },
              ],
              practicals: [],
            },
          },
          { id: '6', 
            ...
            resources: { notes: [],
              pyqs: [
                { id: 1, label: 'EVS (Bsc SUM2019)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-fundamentals-of-environmental-science-2028-summer-2019.pdf', type: 'pdf' },
                { id: 2, label: 'EVS (Bsc SUM2019)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-fundamentals-of-environmental-science-2028-summer-2019.pdf', type: 'pdf' },
                { id: 3, label: 'EVS (Bsc SUM2018)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-(fundamentals-of-environmental-science)-summer-2018.pdf', type: 'pdf' },
                { id: 4, label: 'EVS (Bsc WIN2019)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-fundamentals-of-environmental-science-winter-2018.pdf', type: 'pdf' },
                { id: 5, label: 'EVS (Bsc SUM2017)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-1-summer-2017.pdf', type: 'pdf' },
                { id: 6, label: 'EVS (Bsc WIN2019)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-1-winter-2017.pdf', type: 'pdf' },
                { id: 7, label: 'EVS (Bsc SUM2017_1)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-2-summer-2017.pdf', type: 'pdf' },
                { id: 8, label: 'EVS (Bsc WIN2017_1)', url: 'https://www.rtmnuonline.com/papers/bsc-1-sem-environmental-science-2-winter-2017.pdf', type: 'pdf' },
              ],
              lectures: [
                { id: 1, label: 'Link 1', url: 'https://youtu.be/lyuSJRWsr7Q?si=6_GgL4bgx9UqJgf8', type: 'youtube' },
                { id: 2, label: 'Link 2', url: 'https://youtu.be/gnzpeJGgPXA?si=y7_BaEsSLXO1GIYW', type: 'youtube' },
                { id: 3, label: 'Link 3', url: 'https://youtu.be/C_Yj-rG6Mrc?si=LFGvNHEJVJ7EndJQ', type: 'youtube' },
                { id: 4, label: 'Link 4', url: 'https://youtube.com/playlist?list=PLEcUaC4M400kob4eyp2tVP28nV_oNQP3y&si=DVMRv-b_EDDz6Gq6', type: 'youtube' },
                { id: 5, label: 'Link 5', url: 'https://youtube.com/playlist?list=PLXIPR4CD0nooFtFvd2GlN1qzxy6qhg_nv&si=XzLwYeLlBlAPTpkq', type: 'youtube' },
                { id: 6, label: 'Link 6', url: 'https://youtube.com/playlist?list=PLBLQXAaRIko1787LyH7WcLnvCFAvWhV8O&si=_SplD8NtO6FTbjxx', type: 'youtube' },
                { id: 7, label: 'Link 7', url: 'https://youtube.com/playlist?list=PLVsQZ6ktxcNZYRns5XMA8AUaP5yaQlVze&si=OvUDO9-4SDu1e9Up', type: 'youtube' },
        ...
        subjects: [
          {
            ...
            resources: {
              ...
              lectures: [
                ...
                { id: 12,label: 'Link 12', url: 'https://youtu.be/eWHzz-WHQh4?si=4ltfajO6wg1wk1-c', type: 'youtube' },
                { id: 13,label: 'Link 13', url: 'https://youtu.be/aQatrXw0njs?si=_WEob9oUwGzBoK9M', type: 'youtube' },
                { id: 14,label: 'Link 14', url: 'https://youtu.be/7-lK9EpBS_Y?si=NXm37K_wu16qM2wy', type: 'youtube' },
                { id: 15,label: 'Link 15', url: 'https://youtu.be/NNLoi8QqzaY?si=ce4nQG4wkSNVoxv0', type: 'youtube' },
                { id: 16,label: 'Link 16', url: 'https://youtu.be/32DLasxoOiM?si=lox44Eo4oxgEm5EJ', type: 'youtube' },
                { id: 17,label: 'Link 17', url: 'https://youtu.be/ECT-ehj-q7s?si=60cO4Ze1Ueh3LRv5', type: 'youtube' }, 
              ],
              practicals: [],
            },
          },

          {
            ...
            resources: {
              ...
              pyqs: [
                ...
                { id: 7, label: 'software-engineering-winter-2018', url: 'https://www.rtmnuonline.com/papers/bca-4-sem-software-engineering-1-winter-2018.pdf', type: 'pdf' },
                { id: 8, label: 'software-engineering-summer-2017', url: 'https://www.rtmnuonline.com/papers/bca-4-sem-software-engineering-1-summer-2017.pdf', type: 'pdf' },
                { id: 9, label: 'software-engineering-winter-2017', url: 'https://www.rtmnuonline.com/papers/bca-4-sem-software-engineering-1-winter-2017.pdf', type: 'pdf' },
                { id:10, label: 'software-engineering-summer-2016', url: 'https://www.rtmnuonline.com/papers/bca-4-sem-software-eng-1-summer-2016.pdf', type: 'pdf' },
                { id:11, label: 'software-engineering-winter-2023', url: 'https://www.rtmnuonline.com/papers/bca-5-sem-software-engineering-1321-c-winter-2023.pdf', type: 'pdf' },
                { id:12, label: 'software-engineering-summer-2019', url: 'https://www.rtmnuonline.com/papers/bca-5-sem-software-engineering-2-2240-summer-2019.pdf', type: 'pdf' },
              ],
              lectures: [
                ...
                { id: 9, label: 'Link 9 ', url: 'https://youtu.be/Wnk_pArBylM?si=Ql3gI0nW4Jyv7vUV', type: 'youtube' },
                { id: 10,label: 'Link 10', url: 'https://youtu.be/NlLM3sVF8wY?si=0eCfmDEiNvEBjuzc', type: 'youtube' },
                { id: 11,label: 'Link 11', url: 'https://youtu.be/OJ8PedIbZmE?si=kBJq0w3nZ175FX-e', type: 'youtube' },
                { id: 12,label: 'Link 12', url: 'https://youtu.be/yCO4sPi_nIY?si=9-tW2bdr-4PnpLjM', type: 'youtube' },
                { id: 13,label: 'Link 13', url: 'https://youtu.be/rZoQ13n_NDE?si=Qln2Eche1BngI0bv', type: 'youtube' },
                { id: 14,label: 'Link 14', url: 'https://youtube.com/playlist?list=PLmAmHQ-_5ySyCjVtHdSjJ64QU2x5TH8Dy&si=n0t0zDb6GzzFkEz-', type: 'youtube' },
                { id: 15,label: 'Link 15', url: 'https://youtube.com/playlist?list=PLvu-LC7buiaXLZ6P6ePiAhAI1uTWfyVXZ&si=LKbiSL63bi1YucTU', type: 'youtube' },
              ],
...

          {
            ...
            resources: {
              ...
              lectures: [
                ...
                { id: 4, label: 'Link 4 ', url: 'https://youtube.com/playlist?list=PL-vEH_IPWrhDyJv4uK5K_Kno83d6VKSOg6&si=0N8fIWTCjRe3c05v', type: 'youtube' },
                ...
                { id: 14, label: 'Link 14', url: 'https://youtu.be/gTqV-h_v8Pw?si=eQlBdTkcIiZTQltX', type: 'youtube' }, 
                { id: 15, label: 'Link 15', url: 'https://youtu.be/4CtUyzSters?si=3hoP_0Fw23F5Erst', type: 'youtube' },
                { id: 16, label: 'Link 16', url: 'https://youtu.be/L5sZ6WgOnj0?si=W2pNUEsITaQ2FDdX', type: 'youtube' },  
              ],
              practicals: [],
            },
          },
